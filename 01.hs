...
-- tests
test_suite1 = test_suite_expect "Empty List" myLast [[]] [Nothing:: Maybe Bool]
test_suite2 = test_suite_expect "Not-Null List" myLast [[30], [1..10]] [Just 30, Just 10]

test_suites = [test_suite1, test_suite2]
-- wrapper
main = do
    putStrLn $ name ++ " Start"
