...
-- tests
test_suite1 = test_suite_expect "Empty List" myButLast [[]] [Nothing:: Maybe Bool]
test_suite2 = test_suite_expect "1-len List" myButLast [[20]] [Nothing]
test_suite3 = test_suite_expect "2-len List" myButLast [[1..10]] [Just 9]
...
myButLast [] = Nothing
myButLast [_] = Nothing
myButLast l = foldl (\_ x -> Just x) Nothing $ init l
