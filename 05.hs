...
-- tests
test1=test_suite_expect "Empty List" myReverse [[]] [[] :: [Bool]]
test2=test_suite_expect "1-len List" myReverse [[1]] [[1]]
test3=test_suite_expect "2-len List" myReverse [[1..10]] [[10,9..1]]
